...
//                         onClick={async () => {
//                           try {
//                             await deleteCategory({ id: category.category_id }).unwrap();
  ...
  return (
    <div className="pt-4">
      <div className="container mx-auto">
        ...
        {/* Pagination */}
        <div className="flex justify-center items-center mt-6 gap-2">
          <Button variant="outline" type="button" size="sm" className="bg-gray-800 border-gray-600 text-gray-300 hover:bg-gray-700">
            <ChevronLeft className="h-4 w-4" />
          </Button>
          <Button type="button" size="sm" className="bg-green-600 hover:bg-green-700 text-white min-w-8">
            1
          </Button>
          <Button
            type="button"
          ...
          <Button type="button" variant="outline" size="sm" className="bg-gray-800 border-gray-600 text-gray-300 hover:bg-gray-700">
            <ChevronRight className="h-4 w-4" />
          </Button>
        </div>
