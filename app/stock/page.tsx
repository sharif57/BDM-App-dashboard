 ...
 const handleRemoveProduct = async (item) => {
    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await deleteBatch(item.id ).unwrap();
      ...
      // const errorMessage = error?.data?.message || "Failed to delete stock item. Please try again.";
...
//   const handleAddStock = async () => {
//     if (!selectedProduct  || !costPrice || !sellingPrice || !mrp) {
//       toast.error("Please fill in all fields.");
//       return;
//     }
